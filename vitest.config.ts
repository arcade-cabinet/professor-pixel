...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      //
      // Today's snapshot (2026-05-08, post-runner-post-recovery-wizard-state):
      // statements 88.60%, branches 82.72%, functions 86.05%, lines 89.57%.
      // Branches floor 80 (RATCHETED 79→80 in post-pyodide-ssr-and-existing-tag-
      // undefined-status; floor sits 2.72pt under the aggregate run).
