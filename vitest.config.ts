...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      //
      // Today's snapshot (2026-05-07, post-#116 + templates-registry tests):
      // statements 42.95%, branches 36.37%, functions 37.33%, lines 42.97%.
      ...
      //
      // Earlier snapshots:
      //   2026-05-07 post-#116+templates: 42.95/36.37/37.33/42.97 → floor 41/35/36/41
