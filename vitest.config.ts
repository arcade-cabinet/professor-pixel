...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      //
      // Today's snapshot (2026-05-07, post-interactive-canvas-smoke):
      // statements 76.27%, branches 67.48%, functions 72.12%, lines 77.14%.
      ...
      //   2026-05-07 post-ssr-fallbacks: 74.39/64.98/70.31/75.22 → floor 74/63/70/75
