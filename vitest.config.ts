...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      //
      // Today's snapshot (2026-05-07, post-#108 + dialog tests):
      // statements 41.40%, branches 34.30%, functions 35.97%, lines 41.41%.
      ...
      //
      // Earlier snapshots:
      //   2026-05-07 post-#108+dialog: 41.40/34.30/35.97/41.41 → floor 40/33/34/40
