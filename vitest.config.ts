...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      //
      // Today's snapshot (2026-05-08, post-pyodide-cache-ssr-window):
      // statements 88.68%, branches 83.07%, functions 86.05%, lines 89.62%.
      // Branches floor 80 (RATCHETED 79→80 in post-pyodide-ssr-and-existing-tag-
      // undefined-status; floor sits 3.07pt under the aggregate run).
      // Four consecutive runs at 83+ (83.04, 83.04, 83.00, 83.07). Envelope
      // 82.97–83.07 is durable but lower edge still leaves only 1.97pt
      // cushion above floor 81. Ratchet 80→81 stays deferred until actuals
      // reach 83.5+.
      ...
      //   2026-05-08 post-play-compile-error-no-message: 88.59/82.74/85.99/89.57 → floor 87/80/85/88
      //   2026-05-08 post-runner-post-recovery-wizard-state: 88.60/82.72/86.05/89.57 → floor 87/80/85/88
      //   2026-05-08 post-runner-recovery-failed-paths: 88.59/82.70/85.99/89.57 → floor 87/80/85/88
      //   2026-05-08 post-runner-init-failure-paths: 88.59/82.65/85.99/89.57 → floor 87/80/85/88
      //   2026-05-08 post-home-remix-null-snapshot: 88.55/82.60/85.99/89.52 → floor 87/80/85/88
      ...
      //   2026-05-08 post-profile-page-edge-paths: 88.43/81.17/85.99/89.48 → floor 87/79/85/88
      ...
      //   2026-05-08 post-client-storage-ssr-no-window: 88.37/80.78/86.05/89.46 → floor 87/79/85/88
      //   2026-05-08 post-profile-storage-ssr-no-localstorage: 88.33/80.71/86.05/89.46 → floor 87/79/85/88
      //   2026-05-08 post-compiler-asset-no-path-fallback: 88.32/80.66/86.05/89.46 → floor 87/79/85/88
      ...
      //   2026-05-08 post-runner-init-error-non-error-and-no-onerror: 88.26/80.22/85.99/89.46 → floor 87/79/85/88
      //   2026-05-08 post-simulator-harness-self-tests: 88.26/80.22/86.05/89.46 → floor 87/79/85/88
      //   2026-05-08 post-pixel-minimized-hover-tooltip-fires: 88.24/80.20/85.99/89.48 → floor 87/79/85/88 (RATCHETED branches 78→79)
      ...
      //   2026-05-08 post-building-blocks-system-init-branches: 88.07/79.53/85.75/89.37 → floor 87/78/85/88
      ...
      //   2026-05-08 post-manager-preload-music-and-other-type: 88.01/79.34/85.75/89.32 → floor 87/78/85/88
      ...
      //   2026-05-08 post-opfs-projects-missing-wizard-file: 88.03/79.07/85.81/89.32 → floor 87/78/85/88
      ...
      //   2026-05-08 post-sfx-master-off-error-pop: 87.89/78.76/85.81/89.24 → floor 87/77/85/88
      //   2026-05-08 post-use-toast-reducer-branches: 87.84/78.74/85.75/89.24 → floor 87/77/85/88
      ...
      //   2026-05-08 post-console-logger-defaults-and-trim: 87.91/78.44/85.87/89.30 → floor 87/77/85/88
      ...
      //   2026-05-08 post-use-debug-default-labels: 87.66/78.05/85.75/89.04 → floor 87/77/85/88
      ...
      //   2026-05-08 post-exporter-no-path-asset: 87.37/77.65/85.37/88.79 → floor 87/77/85/88
      //   2026-05-08 post-dialogue-flow-load-error: 87.36/77.63/85.43/88.75 → floor 87/77/85/88
