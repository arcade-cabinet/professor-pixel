...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      //
      // Today's snapshot (2026-05-08, post-code-generator-background-fallbacks):
      // statements 88.36%, branches 80.80%, functions 85.99%, lines 89.46%.
      // Branches floor 79 (ratcheted 78→79 in post-pixel-minimized-hover; floor
      // sits 1.80pt under the aggregate run).
