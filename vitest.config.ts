...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      //
      // Today's snapshot (2026-05-08, post-simulator-harness-self-tests):
      // statements 88.26%, branches 80.22%, functions 86.05%, lines 89.46%.
      // Branches floor 79 (ratcheted 78→79; aggregate cleared 80% for the first
      // time, conservative floor sits 1.22pt under the run).
