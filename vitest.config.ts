...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      //
      // Today's snapshot (2026-05-07, post-#97 + dialog tests):
      // statements 40.32%, branches 33.31%, functions 34.50%, lines 40.32%.
      ...
      //
      // Earlier snapshots:
      //   2026-05-07 post-#97+dialog: 40.32/33.31/34.50/40.32 → floor 39/32/33/39
