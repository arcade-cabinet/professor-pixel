...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      //
      // Today's snapshot (2026-05-07, post-#104 + python-runner tests):
      // statements 41.05%, branches 34.03%, functions 35.34%, lines 41.05%.
      ...
      //
      // Earlier snapshots:
      //   2026-05-07 post-#104+runner: 41.05/34.03/35.34/41.05 → floor 40/33/34/40
