...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      //
      // Today's snapshot (2026-05-07, post-home-page-smoke):
      // statements 77.25%, branches 68.41%, functions 73.38%, lines 78.21%.
      ...
      //   2026-05-07 post-canvas-drag: 74.79/65.23/70.43/75.63 → floor 74/64/70/75
