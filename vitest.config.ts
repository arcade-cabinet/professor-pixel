...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      //
      // Today's snapshot (2026-05-07, post-#111 + python-runner tests):
      // statements 42.18%, branches 35.82%, functions 36.28%, lines 42.18%.
      ...
      //
      // Earlier snapshots:
      //   2026-05-07 post-#111+runner: 42.18/35.82/36.28/42.18 → floor 41/34/35/41
